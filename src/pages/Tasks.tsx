...
export function Tasks() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center min-h-[70vh]">
      <div className="w-20 h-20 bg-[#2c2c2e] rounded-full flex items-center justify-center mb-6 shadow-inner border border-white/5">
        <Target size={36} className="text-blue-500" />
      </div>
      <h2 className="text-2xl font-bold text-white mb-3">Tasks</h2>
